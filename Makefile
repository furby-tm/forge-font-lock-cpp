...
compile:
	$(emacs) $(emacs_options) --eval="($(byte_compilation) \"forge-font-lock-cpp.el\")"
...
test: prepare_test compile compile_test
	...
	$(emacs) $(emacs_options) -l ert -l forge-font-lock-cpp-setup-test.el -f ert-run-tests-batch-and-exit
